...
## Corpus Check
- 64 files · ~78,761 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 971 nodes · 1845 edges · 51 communities (36 shown, 15 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 47 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `313f1d12`
...
Cohesion: 0.05
Nodes (19): GenUpdate, load_gen_history(), population_get_gen_summary_includes_max_steps(), Default, Option, Self, Vec, SimMetadata (+11 more)

### Community 1 - "Game"
Cohesion: 0.06
Nodes (28): Clone, Ordering, PartialEq, PartialOrd, Send, Agent, Box<dyn Agent>, DqnPolicyAgent (+20 more)

### Community 2 - "GameTheme"
Cohesion: 0.07
Nodes (35): FourDirs, relative_dir(), relative_dir_matches_frame_for_all_12_combinations(), relative_dir_never_returns_backward(), relative_frame(), rotate_vision_drops_backward_group(), rotate_vision_identity_for_heading_top(), rotate_vision_to_relative() (+27 more)
...
Cohesion: 0.15
Nodes (18): GaSeries, GaChampions, load_ga_champions(), best_and_second_best_produce_a_match_with_the_exact_nets(), champs(), GaVersusInner, GaVersusPlayers, GaVersusView (+10 more)

### Community 5 - "ui_kit.rs"
Cohesion: 0.06
Nodes (43): Cow, Error, GameDQN, Deref, DerefMut, draw(), draw_grid(), draw_key_badge() (+35 more)

### Community 6 - "game_dqn.rs"
Cohesion: 0.24
...
### Community 11 - "SnakeCore"
Cohesion: 0.12
Nodes (14): Into, dynamic_step_limit(), get_four_dir_vision_returns_12_features(), get_random_empty_pos_avoids_body(), get_relative_state_returns_12_features(), is_snake_body_skips_head_segment(), is_wall_rejects_border_and_accepts_inner(), look_in_dir_dqn_wall_reciprocal_in_range() (+6 more)

### Community 12 - "Net"
Cohesion: 0.05
Nodes (34): Layer, matches_arch_accepts_exact_and_rejects_others(), Net, new_delegates_to_new_with_sizes_with_ga_constants(), new_with_sizes_builds_predictable_net(), Self, Vec, GenerationSummary (+26 more)
...
### Community 14 - "Viz"
Cohesion: 0.12
Nodes (13): grid_to_world(), map_to_unit_interval(), are_colors_equal(), color_with_a(), Color, Colors, Color, Default (+5 more)
...
- **Why does `Net` connect `Net` to `Simulation`, `Game`, `view_ga_versus.rs`, `game_dqn.rs`, `view_dqn_train.rs`, `versus.rs`, `dqn.rs`, `view_cross_match.rs`, `Viz`, `view_dqn_versus.rs`?**
  _High betweenness centrality (0.224) - this node is a cross-community bridge._
- **Why does `Game` connect `Game` to `Simulation`, `GameTheme`, `ui_kit.rs`, `versus.rs`, `VsFlavor`, `SnakeCore`, `Net`, `Viz`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Why does `SnakeCore` connect `SnakeCore` to `Game`, `GameTheme`, `ui_kit.rs`, `game_dqn.rs`, `env_config.rs`?**

...
## Corpus Check
- 63 files · ~78,029 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 953 nodes · 1810 edges · 52 communities (37 shown, 15 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 47 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0ec6854b`
...
4. `App` - 33 edges
5. `Simulation` - 27 edges
6. `GameTheme` - 27 edges
7. `SnakeCore` - 26 edges
8. `DqnTrainView` - 25 edges
9. `Viz` - 23 edges
10. `GameDQN` - 21 edges
...
### Community 1 - "Apply Progress — unified-snake-shell (Slices 1–5 of 5)"
Cohesion: 0.05
...
### Community 2 - "App"
Cohesion: 0.07
Nodes (12): Conf, window_conf(), Action, App, app_menu_champion_helpers_dont_panic(), AppMode, MatchView, next_mode() (+4 more)

### Community 3 - "SnakeCore"
Cohesion: 0.12
Nodes (13): Into, get_four_dir_vision_returns_12_features(), get_random_empty_pos_avoids_body(), get_relative_state_returns_12_features(), is_snake_body_skips_head_segment(), is_wall_rejects_border_and_accepts_inner(), look_in_dir_dqn_wall_reciprocal_in_range(), reset_restores_default_state() (+5 more)

### Community 4 - "ui_kit.rs"
Cohesion: 0.09
Nodes (26): Cow, Error, brand_watermark_pos(), calculate_chart_slot_width(), clamp_fraction(), draw_badge(), draw_brand_watermark(), draw_centered_text() (+18 more)

### Community 5 - "GameDQN"
Cohesion: 0.10
Nodes (28): body_segments_stay_contiguous_and_ordered_after_eating(), game_dqn_with_network_preserves_agent_weights_and_epsilon(), GameDQN, observation_directional_food_sensor_detects_diagonal_food(), observation_is_a_stable_9_input_relative_view_without_side_effects(), observation_places_forward_food_in_first_group_when_heading_top(), relative_step_never_reverses_direction(), Deref (+20 more)

### Community 6 - "Game"
Cohesion: 0.07
Nodes (27): Clone, Ordering, PartialEq, PartialOrd, Send, Agent, Box<dyn Agent>, DqnPolicyAgent (+19 more)
...
### Community 9 - "versus.rs"
Cohesion: 0.12
Nodes (18): BestOfSeries, BestOfSeries<B>, headless_cross_match_ga_vs_dqn_terminates(), headless_match_respects_zero_tick_budget(), headless_match_with_random_brains_terminates_and_yields_winner(), headless_relative_match_terminates_and_yields_winner(), resolve_winner(), B (+10 more)

### Community 10 - "VsFlavor"
Cohesion: 0.13
Nodes (17): SeriesInfo, StageResult, format_stage_summary(), ga_default_flavor_pins_legacy_colors(), ga_default_flavor_pins_legacy_strings(), record_none_flavor_carries_no_record_semantics(), B, Color (+9 more)
...
### Community 14 - "view_dqn_versus.rs"
Cohesion: 0.13
...
### Community 16 - "Training dashboard UI Apply Progress Slice A"
Cohesion: 0.10
...
### Community 17 - "GameTheme"
Cohesion: 0.07
Nodes (35): P, FourDirs, relative_dir(), relative_dir_matches_frame_for_all_12_combinations(), relative_dir_never_returns_backward(), relative_frame(), rotate_vision_drops_backward_group(), rotate_vision_identity_for_heading_top() (+27 more)

### Community 18 - "Viz"
Cohesion: 0.13
Nodes (12): grid_to_world(), map_to_unit_interval(), are_colors_equal(), color_with_a(), Colors, Color, Default, Instant (+4 more)

### Community 19 - "Snake Rust — app unificada (crate `snake`)"
Cohesion: 0.29
Nodes (6): Champions, Ejecutar, Estructura, IA-juego-snake-rust, Snake Rust — app unificada (crate `snake`), Teclas por vista

### Community 20 - "Deep Q-Network (DQN) Implementation"
Cohesion: 0.08
...
### Community 21 - "champion_store.rs"
Cohesion: 0.17
...
### Community 22 - "SwallowTracker"
Cohesion: 0.20
Nodes (7): advance_shifts_bulge_along_body_and_evicts_at_max_len(), eating_triggers_head_chew_and_starts_bulge_at_zero(), fresh_swallow_tracker_has_no_bulges_and_no_chew(), multiple_bulges_can_travel_simultaneously(), Self, Vec, SwallowTracker

### Community 23 - "Canonical no regression of GA evolution behavior"
Cohesion: 0.67
...
### Community 27 - "Exploration: unified-snake-shell"
Cohesion: 0.15
...
### Community 28 - "Unified Snake Shell — Proposal"
Cohesion: 0.17
...
### Community 29 - "Module Hierarchy & Backwards Compatibility"
Cohesion: 0.18
...
### Community 38 - "Unified Snake Shell — Design"
Cohesion: 0.18
...
### Community 39 - "3. Especificación Detallada por Módulo"
Cohesion: 0.20
...
### Community 44 - "Phase 3: Game Engine Unification (SnakeCore) — Implementation Plan"
Cohesion: 0.25
...
### Community 49 - "Phase 5: Domain Layer Purification — Implementation Plan"
Cohesion: 0.33
...
- **Why does `Net` connect `Net` to `Stream`, `GameDQN`, `Game`, `view_dqn_train.rs`, `versus.rs`, `dqn.rs`, `GaTrainView`, `view_cross_match.rs`, `view_dqn_versus.rs`, `Viz`, `champion_store.rs`?**
  _High betweenness centrality (0.222) - this node is a cross-community bridge._
- **Why does `Game` connect `Game` to `Stream`, `SnakeCore`, `ui_kit.rs`, `versus.rs`, `VsFlavor`, `Net`, `GameTheme`, `Viz`?**
  _High betweenness centrality (0.135) - this node is a cross-community bridge._
- **Why does `SnakeCore` connect `SnakeCore` to `GameTheme`, `GameDQN`, `Game`, `SwallowTracker`?**
...
- **Should `Apply Progress — unified-snake-shell (Slices 1–5 of 5)` be split into smaller, more focused modules?**
